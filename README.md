...
**_We recommend that the user run these code on google colab platform, thus the tedious environment configuration is not required for your local computer._** 
## Step 1
